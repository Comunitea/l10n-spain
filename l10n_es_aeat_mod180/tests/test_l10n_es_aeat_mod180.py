...
from odoo.addons.l10n_es_aeat.tests.test_l10n_es_aeat_real_estate import (
    TestL10nEsAeatRealEstate,
)

_logger = logging.getLogger("aeat")


class TestL10nEsAeatMod180Base(TestL10nEsAeatRealEstate):
    ...
    def _real_estate_create(cls, reference):
        ...
        _logger.debug(f"Creating real estate: reference = {ref}")
        re = (
    ...
    def _invoice_purchase_create_with_real_state(cls, dt, reference, extra_vals=None):
        ...
        for desc, values in cls.taxes_purchase.items():
            ...
            line_data = {
                ...
                "price_unit": values[0],
                "quantity": 1,
                "l10n_es_aeat_real_estate_id": re.id,
            }
    ...
    def test_model_180(self):
        ...
        self._invoice_refund(purchase, "2023-06-18")
