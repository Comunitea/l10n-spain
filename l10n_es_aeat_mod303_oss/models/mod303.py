...
class L10nEsAeatMod303Report(models.Model):
    ...
    def get_taxes_from_map(self, map_line):
        ...
        oss_map_lines = [
            ...
            self.env.ref(module + ".aeat_mod303_2023_map_line_123"),
            self.env.ref(module + ".aeat_mod303_2023_map_line_126"),
        ]
    ...
    def _get_tax_lines(self, codes, date_start, date_end, map_line):
        ...
        """
        res = super()._get_tax_lines(codes, date_start, date_end, map_line)
